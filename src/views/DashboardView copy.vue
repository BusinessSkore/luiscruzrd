<template>
  <!-- <iframe
    v-if="this.$store.state.user.type == 'ARSSENASA'"
    width="960"
    height="720"
    src="https://us-east-1.quicksight.aws.amazon.com/sn/embed/share/accounts/537976118724/dashboards/879848e2-d070-4ae4-9e47-fba278b2fc65?directory_alias=isys-quicksight-account"
  >
  </iframe> -->
  <div class="backgrnd">
    <Navbar />
    ...
    <div v-show="!cargando" class="general">
      <h3 v-if="this.$store.state.user.type == 'NUTRIMED'">
        Dashboard
      </h3>
      <button
...
import { getproddayli } from "@/services/cruzjiminiancj/Producto";
