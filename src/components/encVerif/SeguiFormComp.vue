      ...
      <div v-show="!cargando" class="general">
          ...
          <div class="contenedor">
            ...
            <div class="contenido">
              ...
              <div class="contenido">
                ...
                <button
                  class="btn btn-info"
                  @click.prevent="this.$router.push('/listevalsencvalid')"
                >
                  Ver Listado
                </button>
              </div>
        ...
        <form>
          <fieldset>
            ...
            <label class="form-label"><b>Evaluación Funcional</b></label>
            <div class="grid">
              <div>
                <label
                  class="ta-l col-form-label col-form-label-sm"
              ...
              <div>
                <label
                  ...
                  >FRECUENCIA CARDIACA (l/m):</label
                ><input
                  @change="cualificarFC(evaluacion.frecuencia_cardiaca)"
              ...
              <div>
                ...
                ><input
                  ...
                  id="estadoFuerza"
                  type="estadoFuerza"
                  v-model="evaluacion.estadoFuerza"
                  class="form-control"
                />
              </div>
            </div>
            <div class="grid">
              ...
              <div>
                <label
                  ...
                  >FLEX. MIEMBROS SUPERIORES:</label
                ><input
                  @change="fixFlexibilidad_miembro_superior()"
              ...
              <div>
                <label
                  ...
                  >FLEX. MIEMBROS INFERIORES:</label
                ><input
                  @change="fixFlexibilidad_miembro_inferior()"
            ...
            <label class="form-label"
              ><b>Tamizaje Nutricional Adulto Mayor</b></label
            >
            <div class="grid-oneLine selects">
              <div>
                <p for="eval_nutri_1">
                  1.¿TIENE ALGUNA ENFERMEDAD O CONDICIÓN QUE LE HA HECHO CAMBIAR
                  LA CLASE O LA CANTIDAD DE ALIMENTO QUE CONSUME?
                </p>
                <select
                  @change="this.calcRiesgoNutricional()"
                  id="eval_nutri_1"
                  type="eval_nutri_1"
              ...
              <div>
                <p for="eval_nutri_2">2.¿COME MENOS DE 2 COMIDAS AL DÍA?</p>
                <select
                  @change="this.calcRiesgoNutricional()"
                  id="eval_nutri_2"
                  type="eval_nutri_2"
              ...
              <div>
                <p for="eval_nutri_3">
                  3.¿COME POCAS FRUTAS, VEGETALES O PRODUCTOS DE LECHE?
                </p>
                <select
                  @change="this.calcRiesgoNutricional()"
                  id="eval_nutri_3"
              ...
              <div>
                <p for="eval_nutri_4">
                  4.¿TOMA TRES O MÁS BEBIDAS DE CERVEZA, LICORES O VINO CASI
                  TODOS LOS DÍAS?
                </p>
                <select
                  @change="this.calcRiesgoNutricional()"
              ...
              <div>
                <p for="eval_nutri_5">
                  5.¿TIENE PROBLEMAS CON LOS DIENTES O LA BOCA QUE LE DIFICULTAN
                  COMER?
                </p>
                <select
                  @change="this.calcRiesgoNutricional()"
              ...
              <div>
                <p for="eval_nutri_6">
                  6.¿SIEMPRE TIENE SUFICIENTE DINERO PARA COMPRAR LOS ALIMENTOS
                  QUE NECESITAS?
                </p>
                <select
                  @change="this.calcRiesgoNutricional()"
              ...
              <div>
                <p for="eval_nutri_8">
                  8.¿TOMA AL DÍA TRES O MÁS MEDICINAS DIFERENTES, CON O SIN
                  RECETA?
                </p>
                <select
                  @change="this.calcRiesgoNutricional()"
              ...
              <div>
                <p for="eval_nutri_9">
                  9.¿HA GANADO O PERDIDO PESO, SIN QUERER, 4,5 KG (10 LIBRAS) EN
                  LOS ÚLTIMOS 6 MESES?
                </p>
                <select
                  @change="this.calcRiesgoNutricional()"
              ...
              <div>
                <p for="eval_nutri_10">
                  10.¿FÍSICAMENTE PUEDE IR DE COMPRAS, COCINAR O ALIMENTARSE?
                </p>
                <select
                  @change="this.calcRiesgoNutricional()"
                  id="eval_nutri_10"
              ...
              <div>
                ...
                <input
                  disabled
                  id="riesgoNutricional"
                  type="riesgoNutricional"
                  v-model="evaluacion.riesgoNutricional"
                  class="form-select"
                />
              </div>
            </div>
            ...
            <div class="radios">
              <p style="margin: 0" for="eval_nutri_2">
                2.¿COME MENOS DE 2 COMIDAS AL DÍA?
              </p>
              <div class="form-check grid-radio">
                <div>
                  <input
                    id="true_radio_eval_nutri_2"
                    class="form-check-input"
                    type="radio"
                    v-model="evaluacion.eval_nutri_2"
                    value="SI"
                  /><label
                    class="form-check-label"
                    for="true_radio_eval_nutri_2"
                    >SI</label
                  >
                </div>
                <div>
                  <input
                    id="false_radio_eval_nutri_2"
                    class="form-check-input"
                    type="radio"
                    v-model="evaluacion.eval_nutri_2"
                    value="NO"
            ...
            <div class="radios">
              <p style="margin: 0" for="eval_nutri_3">
                3.¿COME POCAS FRUTAS, VEGETALES O PRODUCTOS DE LECHE?
              </p>
              <div class="form-check grid-radio">
                <div>
                  <input
                    id="true_radio_eval_nutri_3"
                    class="form-check-input"
                    type="radio"
                    v-model="evaluacion.eval_nutri_3"
                    value="SI"
                  /><label
                    class="form-check-label"
                    for="true_radio_eval_nutri_3"
                    >SI</label
                  >
                </div>
                <div>
                  <input
                    id="false_radio_eval_nutri_3"
                    class="form-check-input"
                    type="radio"
                    v-model="evaluacion.eval_nutri_3"
                    value="NO"
            ...
            <div class="radios">
              <p style="margin: 0" for="eval_nutri_4">
                4.¿TOMA TRES O MÁS BEBIDAS DE CERVEZA, LICORES O VINO CASI TODOS
                LOS DÍAS?
              </p>
              <div class="form-check grid-radio">
                <div>
                  <input
                    id="true_radio_eval_nutri_4"
                    class="form-check-input"
                    type="radio"
                    v-model="evaluacion.eval_nutri_4"
                    value="SI"
                  /><label
                    class="form-check-label"
                    for="true_radio_eval_nutri_4"
                    >SI</label
                  >
                </div>
                <div>
                  <input
                    id="false_radio_eval_nutri_4"
                    class="form-check-input"
                    type="radio"
                    v-model="evaluacion.eval_nutri_4"
                    value="NO"
            ...
            <div class="radios">
              <p style="margin: 0" for="eval_nutri_5">
                5.¿TIENE PROBLEMAS CON LOS DIENTES O LA BOCA QUE LE DIFICULTAN
                COMER?
              </p>
              <div class="form-check grid-radio">
                <div>
                  ...
                  /><label
                    class="form-check-label"
                    for="true_radio_eval_nutri_5"
                    >SI</label
                  >
                </div>
                <div>
                  <input
                    id="false_radio_eval_nutri_5"
                    class="form-check-input"
                    type="radio"
                    v-model="evaluacion.eval_nutri_5"
                    value="NO"
            ...
            <div class="radios">
              <p style="margin: 0" for="eval_nutri_6">
                6.¿SIEMPRE TIENE SUFICIENTE DINERO PARA COMPRAR LOS ALIMENTOS
                QUE NECESITAS?
              </p>
              <div class="form-check grid-radio">
                <div>
                  ...
                  /><label
                    class="form-check-label"
                    for="true_radio_eval_nutri_6"
                    >SI</label
                  >
                </div>
                <div>
                  <input
                    id="false_radio_eval_nutri_6"
                    class="form-check-input"
                    type="radio"
                    v-model="evaluacion.eval_nutri_6"
                    value="NO"
            ...
            <div class="radios">
              <p style="margin: 0" for="eval_nutri_7">
                7.¿COME A SOLAS LA MAYOR PARTE DE LAS VECES?
              </p>
              <div class="form-check grid-radio">
                <div>
                  <input
                    id="true_radio_eval_nutri_7"
                    class="form-check-input"
                    type="radio"
                    v-model="evaluacion.eval_nutri_7"
                    value="SI"
                  /><label
                    class="form-check-label"
                    for="true_radio_eval_nutri_7"
                    >SI</label
                  >
                </div>
                <div>
                  <input
                    id="false_radio_eval_nutri_7"
                    class="form-check-input"
                    type="radio"
                    v-model="evaluacion.eval_nutri_7"
                    value="NO"
            ...
            <div class="radios">
              <p style="margin: 0" for="eval_nutri_8">
                8.¿TOMA AL DÍA TRES O MÁS MEDICINAS DIFERENTES, CON O SIN
                RECETA?
              </p>
              <div class="form-check grid-radio">
                <div>
                  ...
                  /><label
                    class="form-check-label"
                    for="true_radio_eval_nutri_8"
                    >SI</label
                  >
                </div>
                <div>
                  <input
                    id="false_radio_eval_nutri_8"
                    class="form-check-input"
                    type="radio"
                    v-model="evaluacion.eval_nutri_8"
                    value="NO"
            ...
            <div class="radios">
              <p style="margin: 0" for="eval_nutri_9">
                9.¿HA GANADO O PERDIDO PESO, SIN QUERER, 4,5 KG (10 LIBRAS) EN
                LOS ÚLTIMOS 6 MESES?
              </p>
              <div class="form-check grid-radio">
                <div>
                  ...
                  /><label
                    class="form-check-label"
                    for="true_radio_eval_nutri_9"
                    >SI</label
                  >
                </div>
                <div>
                  <input
                    id="false_radio_eval_nutri_9"
                    class="form-check-input"
                    type="radio"
                    v-model="evaluacion.eval_nutri_9"
                    value="NO"
            ...
            <div class="radios">
              <p style="margin: 0" for="eval_nutri_10">
                10.¿FÍSICAMENTE PUEDE IR DE COMPRAS, COCINAR O ALIMENTARSE?
              </p>
              <div class="form-check grid-radio">
                <div>
                  <input
                    id="true_radio_eval_nutri_10"
                    class="form-check-input"
                    type="radio"
                    v-model="evaluacion.eval_nutri_10"
                    value="SI"
                  /><label
                    class="form-check-label"
                    for="true_radio_eval_nutri_10"
                    >SI</label
                  >
                </div>
                <div>
                  <input
                    id="false_radio_eval_nutri_10"
                    class="form-check-input"
                    type="radio"
                    v-model="evaluacion.eval_nutri_10"
                    value="NO"
            ...
            <label class="form-label"
              ><b>Hallazgos, Situación Actual del Paciente</b></label
            >
            <div class="grid">
              <div>
                <label
            ...
            <label class="form-label"
              ><b>Alertas, Gestión de Citas Médicas Especializadas</b></label
            >
            <div class="grid">
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="specialist_appo_psiqui"
                    >PSIQUIATRIA</label
                  >
                  <input
                    class="form-check-input"
              ...
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="specialist_appo_geria"
                    >GERIATRIA</label
                  >
                  <input
                    class="form-check-input"
              ...
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="specialist_appo_orto"
                    >ORTOPEDIA</label
                  >
                  <input
                    class="form-check-input"
              ...
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="specialist_appo_gastro"
              ...
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="specialist_appo_oftal"
                    >OFTALMOLOGIA</label
                  >
                  <input
                    class="form-check-input"
              ...
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="specialist_appo_psicolo"
                    >PSICOLOGIA</label
                  >
                  <input
                    class="form-check-input"
              ...
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="specialist_appo_neurolo"
                    >NEUROLOGIA</label
                  >
                  <input
                    class="form-check-input"
              ...
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="specialist_appo_fisia"
                    >FISIATRIA</label
                  >
                  <input
                    class="form-check-input"
              ...
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="specialist_appo_cardio"
                    >CARDIOLOGIA</label
                  >
                  <input
                    class="form-check-input"
              ...
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="specialist_appo_odonto"
                    >ODONTOLOGIA</label
                  >
                  <input
                    class="form-check-input"
              ...
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="specialist_appo_urolo"
                    >UROLOGIA</label
                  >
                  <input
                    class="form-check-input"
              ...
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="specialist_appo_diabe"
                    >DIABETOLOGIA</label
                  >
                  <input
                    class="form-check-input"
            ...
            <label class="form-label"
              ><b
                >Alertas, Levantamiento de necesidad del Adulto Mayor</b
              ></label
            >
            <div class="grid">
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="Andador 4 Ruedas"
              ...
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="Andador 4 Patas"
              ...
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="Bastón">BASTON</label>
                  <input
                    class="form-check-input"
                    type="checkbox"
              ...
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="Bastón 4 P"
              ...
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="Bastón No VIdente"
                    >BASTON BLANCO (NO VIDENTE)</label
                  >
                  <input
                    class="form-check-input"
                    type="checkbox"
              ...
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="Cama de Posición"
              ...
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="Colchón Aire"
              ...
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="Faja Obdominal"
              ...
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="Glucómetro"
                    >GLUCOMETRO</label
                  >
                  <input
                    class="form-check-input"
              ...
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="Inodoro Porta"
              ...
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="Muletas">MULETAS</label>
                  <input
                    class="form-check-input"
                    type="checkbox"
              ...
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="Pampers XL"
                    >PAMPERS XL</label
                  >
                  <input
                    class="form-check-input"
              ...
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="Pampers L"
                    >PAMPERS L</label
                  >
                  <input
                    class="form-check-input"
              ...
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="Pampers M"
                    >PAMPERS M</label
                  >
                  <input
                    class="form-check-input"
              ...
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="Pampers S"
                    >PAMPERS S</label
                  >
                  <input
                    class="form-check-input"
              ...
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="Silla de Baño"
                    >SILLA DE BAÑO</label
                  >
                  <input
                    class="form-check-input"
              ...
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="Media de Comprensión"
            ...
            <label class="form-label"
              ><b>Entrega de Suplementación Oral</b></label
            >
            <div class="grid">
              <div>
                ...
                >
                  <option>KIT 1</option>
                  <option>KIT 2A</option>
                  <option>KIT 2B</option>
                  <option>KIT 3</option>
                </select>
              </div>
              <div>
                <div class="form-check form-switch">
                  <label class="form-check-label" for="cambioKit"
                    >CAMBIO DE KIT</label
                  >
                  <input
                    class="form-check-input"
                    type="checkbox"
                    v-model="evaluacion['cambioKit']"
                    id="cambioKit"
                  />
                </div>
              </div>
            </div>
            <div v-show="evaluacion['cambioKit']" class="grid">
              <div>
                <label
                  class="ta-l col-form-label col-form-label-sm"
                  for="justificacionCambioKit"
                  >JUSTIFICACION CAMBIO DE KIT:</label
                ><textarea
                  id="justificacionCambioKit"
                  type="justificacionCambioKit"
                  v-model="evaluacion.justificacionCambioKit"
                  class="form-control"
                />
              </div>
            </div>
            <div class="grid">
              ...
              <div>
                <label
                  class="ta-l col-form-label col-form-label-sm"
                  for="comentaryNutri"
                  >COMENTARIO NUTRICIONISTA:</label
                ><textarea
                  disabled
                  rows="3"
                  id="comentaryNutri"
                  type="comentaryNutri"
                  v-model="evaluacion.comentaryNutri"
                  class="form-control"
                />
              </div>
            </div>
            ...
            >
              ...
              <label class="form-label"><b>Verificación</b></label>
              <div class="grid-verif">
                <div>
                  <div class="form-check form-switch">
                    <label class="form-check-label" for="datPersCorrc"
                      >DATOS PERSONALES CORRECTOS</label
                    ><input
                      @change="isVerified()"
                      class="form-check-input"
                      type="checkbox"
                      v-model="evaluacion.datPersCorrc"
                      id="datPersCorrc"
                    />
                  </div>
                </div>
                <div>
                  <div class="form-check form-switch">
                    <label class="form-check-label" for="todCompc"
                      >TODOS LOS CAMPOS COMPLETOS</label
                    ><input
                      @change="isVerified()"
                      class="form-check-input"
                      type="checkbox"
                      v-model="evaluacion.todCompc"
                      id="todCompc"
                    />
                  </div>
                </div>
                <div>
                  <div class="form-check form-switch">
                    <label class="form-check-label" for="pacRefe"
                      >PACIENTE REFERIDO</label
                    ><input
                      @change="isVerified()"
                      class="form-check-input"
                      type="checkbox"
                      v-model="evaluacion.pacRefe"
                      id="pacRefe"
                    />
                  </div>
                </div>
                <div>
                  <div class="form-check form-switch">
                    <label class="form-check-label" for="asiCiónCorc"
                      >ASIGNACIÓN DE KIT CORRECTA</label
                    ><input
                      @change="isVerified()"
                      class="form-check-input"
                      type="checkbox"
                      v-model="evaluacion.asiCiónCorc"
                      id="asiCiónCorc"
                    />
                  </div>
                </div>
                <div>
                  <div class="form-check form-switch">
                    <label class="form-check-label" for="comsPert"
                      >COMENTARIOS PERTINENTES</label
                    ><input
                      @change="isVerified()"
                      class="form-check-input"
                      type="checkbox"
                      v-model="evaluacion.comsPert"
                      id="comsPert"
                    />
                  </div>
                </div>
                <div>
                  <div class="form-check form-switch">
                    <label class="form-check-label" for="escSirsCorr"
                      >ESCÁNER SIRS CORRECTO</label
                    ><input
                      @change="isVerified()"
                      class="form-check-input"
                      type="checkbox"
                      v-model="evaluacion.escSirsCorr"
                      id="escSirsCorr"
                    />
                  </div>
                </div>
                <div>
                  <div class="form-check form-switch">
                    <label class="form-check-label" for="escEvCoc"
                      >ESCANER EVALUACIÓN CORRECTO</label
                    ><input
                      @change="isVerified()"
                      class="form-check-input"
                      type="checkbox"
                      v-model="evaluacion.escEvCoc"
                      id="escEvCoc"
                    />
                  </div>
                </div>
                <div>
                  <div class="form-check form-switch">
                    <label class="form-check-label" for="todFirmCompc"
                      >TODAS LAS FIRMAS COMPLETAS</label
                    ><input
                      @change="isVerified()"
                      class="form-check-input"
                      type="checkbox"
                      v-model="evaluacion.todFirmCompc"
                      id="todFirmCompc"
                    />
                  </div>
                </div>
                <div>
                  <div class="form-check form-switch">
                    <label class="form-check-label" for="todCorrc"
                      >TODAS LAS FIRMAS CORRECTAS</label
                    ><input
                      @change="isVerified()"
                      class="form-check-input"
                      type="checkbox"
                      v-model="evaluacion.todCorrc"
                      id="todCorrc"
                    />
                  </div>
                </div>
                <div>
                  <div class="form-check form-switch">
                    <label class="form-check-label" for="sinTachadEnm"
                      >SIN TACHADURA O ENMENDADURA</label
                    ><input
                      @change="isVerified()"
                      class="form-check-input"
                      type="checkbox"
                      v-model="evaluacion.sinTachadEnm"
                      id="sinTachadEnm"
                    />
                  </div>
                </div>
            ...
            <button
              ...
              @click="
                this.$router.push(`/listevalsencvalid2/${evaluacion._id}`)
              "
            >
...
export default defineComponent({
  ...
  methods: {
      ...
      if (confirm("¿Está Seguro que Desea Eliminar Esta Evaluación?")) {
        ...
        try {
          const res = await destroy(
            ...
            async (res) => {
              await this.toggleLoading();
              this.$router.push("/listevalsencvalid");
            },
            (err) => {
              this.toggleLoading();
              console.error(err);
    ...
    async redirect(id: string) {
      // alert("Redirecting");
      this.$router.push(`/listevalsencvalid/${id}`);
    ...
    fillFields() {
      ...
      this.evaluacion.evaluacion = false;
