        ...
        <form>
          <fieldset>
            ...
            <button
              ...
              @click="this.$router.push(`/listevalsencvalid2/${evaluacion._id}`)"
            >
...
export default defineComponent({
  ...
  methods: {
    ...
    async uploadFile() {
      ...
      // this.$router.push("/listevalsmednutric");
    },
