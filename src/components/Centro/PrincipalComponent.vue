<template v-show="!cargando">
  <div>
    ...
    <div v-show="!cargando" class="general">
      ...
      <div class="grid">
        <div style="margin-top: 40px" class="centros">
          <h4>
            Centros
            <i
              style="cursor:pointer"
              @click="this.$router.push(`/centros/new`)"
              class="fas fa-plus"
              _mstvisible="2"
            ></i>
          </h4>
          ...
          <div class="card-body">
            <ListadoComponent :centros="centros" v-show="!cargando" />
          </div>
        </div>
      </div>
    </div>
...
.grid {
  ...
  grid-template-areas:
    ...
    "centros centros centros centros centros centros centros";
}
