          ...
          <div class="contenedor">
            ...
            <div class="contenido">
              ...
              <div class="contenido">
                ...
                <button
                  class="btn btn-info"
                  @click.prevent="this.$router.push('/listevalssupSitio')"
                >
                  Ver Listado
                </button>
              </div>
        ...
        <form>
          <fieldset>
            ...
            >
              ...
              <label v-if="this.evaluacion.evaluado" class="form-label"><b>Verificación</b></label>

              <div v-if="this.evaluacion.evaluado" class="grid-verif">
                <div>
                ...
                <div>
                  <div class="form-check form-switch">
                    <label class="form-check-label" for="evaluacion"
                      >ESCANER EVALUACIÓN CARGADO</label
                    ><input
                      @change="isVerified()"
                      class="form-check-input"
                      type="checkbox"
              ...
              <div v-if="this.evaluacion.evaluado">
                <div class="form-check form-switch">
                  ...
                  ><input
                    ...
                    class="form-check-input"
                    type="checkbox"
                    v-model="evaluacion.verificacion"
                    id="verificacion"
                  />
                </div>
              </div>
            ...
            <button
              ...
              @click="this.$router.push(`/listevalssupSitio2/${evaluacion._id}`)"
            >
...
export default defineComponent({
  ...
  methods: {
    verifyAll() {
      if (this.evaluacion.verificacion == false) {
        this.evaluacion.datPersCorrc = false;
        this.evaluacion.todCompc = false;
        this.evaluacion.pacRefe = false;
        this.evaluacion.asiCiónCorc = false;
        this.evaluacion.comsPert = false;
        this.evaluacion.escSirsCorr = false;
        this.evaluacion.escEvCoc = false;
        this.evaluacion.todFirmCompc = false;
        this.evaluacion.todCorrc = false;
        this.evaluacion.sinTachadEnm = false;
      ...
      if (confirm("¿Está Seguro que Desea Eliminar Esta Evaluación?")) {
        ...
        try {
          const res = await destroy(
            ...
            async (res) => {
              await this.toggleLoading();
              this.$router.push("/listevalssupSitio");
            },
            (err) => {
              this.toggleLoading();
              console.error(err);
    ...
    async redirect(id: string) {
      // alert("Redirecting");
      this.$router.push(`/listevalssupSitio/${id}`);
