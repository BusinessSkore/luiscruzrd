...
import ListadoComponent from "@/components/Evaluacion/ListComponentFacts.vue";
  ...
  methods: {
    downloadCSV() {
      ...
      const csvString = [
        ...
        ...this.evaluacions.map((item: any) => [item.kit, item.nombre]),
      ];
      // let rows = [
      ...
      // const rows = JSON.stringify(this.evaluacions)
      ...
      // const csvContent = parse(this.evaluacions);
